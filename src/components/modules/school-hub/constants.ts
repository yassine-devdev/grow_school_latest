...
import ChildsProgress from './parent/ChildsProgress';
...
export type L1Tab = 'School' | 'Administration' | 'Teacher' | 'Finance' | 'Marketing' | 'Student' | 'Parent';
...
export const schoolHubData: Record<L1Tab, ReportItem[]> = {
  School: [
  ...
  Parent: [
    ...
    { id: 'parent.progress', name: 'Learning Pulse Tracker', icon: Icons.LearningPulseTracker, component: ChildsProgress },
...
export const L1_TABS: { id: L1Tab; name: string; icon: React.ReactNode }[] = [
  { id: 'School', name: 'School', icon: React.createElement(Icons.School, { size: 18 }) },
  { id: 'Administration', name: 'Administration', icon: React.createElement(Icons.Administration, { size: 18 }) },
  { id: 'Teacher', name: 'Teacher', icon: React.createElement(Icons.Students, { size: 18 }) },
  { id: 'Finance', name: 'Finance', icon: React.createElement(Icons.Finance, { size: 18 }) },
  { id: 'Marketing', name: 'Marketing', icon: React.createElement(Icons.Marketing, { size: 18 }) },
  { id: 'Student', name: 'Student', icon: React.createElement(Icons.Students, { size: 18 }) },
  { id: 'Parent', name: 'Parent', icon: React.createElement(Icons.Users, { size: 18 }) },
];
