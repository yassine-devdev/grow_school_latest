...
const CourseEnrollment: React.FC = () => {
  return (
    <div className="school-hub-content-pane">
        ...
        <h2 className="font-orbitron text-4xl font-bold text-white mb-2">Course Enrollment</h2>
        <p className="text-gray-400">Student / Course Enrollment & Management</p>
        <div className="content-container-bordered mt-6 w-full max-w-lg h-64 bg-black/20 rounded-lg flex items-center justify-center">
            <p className="text-gray-500">Content for Course Enrollment would be displayed here.</p>
        </div>
    </div>
  );
};
